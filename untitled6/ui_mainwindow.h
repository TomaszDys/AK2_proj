...
"    padding: 2px;"));
        ...
        cppTimer = new QLCDNumber(centralWidget);
        cppTimer->setObjectName(QString::fromUtf8("asmTimer"));
        cppTimer->setGeometry(QRect(400, 590, 211, 41));
        cppTimer->setSmallDecimalPoint(false);
        cppTimer->setDigitCount(9);
        cppTimer->setProperty("value", QVariant(0.000000000000000));
        ...
        asmTimer->setObjectName(QString::fromUtf8("cTimer"));
